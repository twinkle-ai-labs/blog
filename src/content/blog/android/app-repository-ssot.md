...
지난 글에서는 하루를 통째로 구조에 쓴 이야기를 했어요.
...
처음부터 이랬던 건 아니에요. 한때는 전부 JSON 한 덩이였습니다.
...
> 저장된 이름은 사람이 볼 것이 아니라 옛 저장본과 맺은 약속이다.
...
이건 실패해도 사용자가 잃을 게 없는 자리입니다. 옛 덩이는 그대로 남아 있으니까요.
